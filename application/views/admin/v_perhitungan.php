        ...
        <div class="card-body">
            <div class="tab-content" id="custom-tabs-four-tabContent">
                <div class="tab-pane fade show active" id="custom-tabs-four-nilai_matrix" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
                    ...
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <th rowspan="2" style="text-align: center;">Universitas</th>
                ...
                <div class="tab-pane fade" id="custom-tabs-four-matrix_ternormalisasi" role="tabpanel" aria-labelledby="custom-tabs-four-profile-tab">
                    <h3>Nilai Matrix Ternormalisasi</h3>
                    <?php
                    $kriteria = $this->db->get('tb_kriteria');
                    $s = $kriteria->num_rows();
                        ...
                        <tbody>
                            ...
                            foreach ($al as $key => $value) { ?>
                                <tr>
                                    ...
                                    $at = $this->M_perhitungan->id_alternatif($id_alternatif);
                                    foreach ($at as $att) {
                                        $id_kriteria = $att['id_kriteria'];
                                        // nilai kuadrat
                                        $nilai_kuadrat = 0;
                                        $ki = $this->M_perhitungan->id_kriteria($id_kriteria);
                                        foreach ($ki as $kii) {
                                            // pembagi
                                    ...
                                    ?>
                                        <td>
                                            <center><?php echo round(($att['nilai'] / sqrt($nilai_kuadrat)), 4); ?></center>
                                        </td>
                                    <?php } ?>
                ...
                <div class="tab-pane fade" id="custom-tabs-four-bobot_ternormalisasi" role="tabpanel" aria-labelledby="custom-tabs-four-messages-tab">
                    <h3>Nilai Bobot Ternormalisasi</h3>
                    <?php
                    $kriteria = $this->db->get('tb_kriteria');
                    $s = $kriteria->num_rows();
                                ...
                                <tr>
                                    ...
                                    ?>
                                        <td>
                                            ...
                                            <center><?php echo round(($att['nilai'] / sqrt($snilai_kuadrat)), 4) * $bot; ?>
                                        </td>
                                    <?php } ?>
                                </tr>
                            <?php } ?>
                ...
                <div class="tab-pane fade" id="custom-tabs-four-nilai_preferensi" role="tabpanel" aria-labelledby="custom-tabs-four-settings-tab">
                    ...
                    <form action="<?= base_url('perhitungan/simpan') ?>" method="post">
                        <?php
                        //buat array kolom
                        $i2 = 1;
                        $i3 = 0;
                        ...
                        $a = $this->M_perhitungan->alternatif();
                        //  mysqli_query($koneksi, "SELECT * FROM alternatif");
                        foreach ($a as $da1) {

                            $idalt = $da1['id_alternatif'];
                            ...
                            // echo "<tr>
                            //         <td><center>$i</center></td>
                            //         <td>$da1[alternatif]</</td>
                            //         <td>" . round($final, 4) . "</td>
                            //         </tr>";
                            echo "<input type='text' name='id_altr' value=" . $da1['id_alternatif'] . ">";
                            echo "<input type ='text' name='ymaxx' value=" . $ymaxx . ">";
                        ...
                        foreach ($a as $da) {
                            ...
                            foreach ($ymin as $nymin => $value) {
                                $mins = $_SESSION['ymin'][$nymin];
                                // echo $mins." - ";
                                $final1 = sqrt($jarakp = $jarakp + pow($value - $mins, 2));
                                // echo $final . "||";
                                // echo $jarakp . " || ";
                            }
                            //session min
                            ...
                            $_SESSION['dmin'] = $dpreferensi;
                            // print_r($ymin) . "|";
                            $dminn = round($final1, 3);

                            $last = $final1 / ($final1 + $final);
                            // echo $last;
                            // echo "<tr>
                            // <td><center>$i</center></td>
                            // <td>$da[alternatif]</</td>
                            // <td>" . round($final1, 3) . "</td>
                            // </tr>";
                            //ambil id alternatif
                            echo "<input type ='text' name='dmin' value=" . $dminn . ">";
                            $id_alt[$ii] = $da['id_alternatif'];
                            $_SESSION['id_alt'] = $id_alt;

                            // echo $final1 . "/ (" . $final1 . "+" . $final . ")" . "=" . $last . "|";
                            $i++;
                            $ii++;
                        }
