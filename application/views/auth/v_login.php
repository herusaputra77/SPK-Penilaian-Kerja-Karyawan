                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <img width="30%" src="<?= base_url() ?>assets/gambar/logo.jpg" alt="">
                                        <h1 class="h4 text-gray-900 mb-1">Sistem Penunjang Keputusan</h1>
                                        <h1 class="h4 text-gray-900 mb-4">BAPPEDA SUMBAR</h1>
                                    ...
                                    <form class="user" action="<?= base_url('auth/cek_login') ?>" method="post">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" name="nip" id="exampleInputEmail" placeholder="NIP">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?= form_error('akses', '<span class="text-small text-danger">', '</span>') ?>
                                        ...
                                        <hr>
                                        <a href="<?= base_url('auth/register') ?>" class="btn btn-google btn-user btn-block">
