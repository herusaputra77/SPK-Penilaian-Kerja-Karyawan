...
<head>
    ...
    <link href="<?= base_url() ?>assets/template_backend/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
    <style>
        .table-container {
            overflow: auto;
        }
    ...
    <script type="text/javascript" src="<?= base_url() ?>assets\template_backend\vendor\jquery\jquery.min.js"></script>
